 ...
 */
package com.apress.ejb.controllers;

import com.apress.ejb.entities.Employee;
import com.apress.ejb.servicio.EmployeeServiceLocal;
...
public class EmployeeController extends HttpServlet {
    ...
    private void listarPersonas(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        List<Employee> employees = employeeServiceLocal.listarEmployees();
        request.setAttribute("employees", employees);
        request.getRequestDispatcher("listarEmployee.jsp").forward(request, response);
    }
}
