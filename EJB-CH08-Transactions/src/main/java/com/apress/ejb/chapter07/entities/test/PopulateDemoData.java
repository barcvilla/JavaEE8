...
/**
 * Helper Class que llama operaciones como persistenceEntity(), removeCustomerOrder() del facade sin una llamada explicita
 * a la operacion a ser committed lo cual es una indicacion que el facade utiliza un comportamiendo de committed implicito.
 * @author PC
 */
public class PopulateDemoData {
  ...
  public static void main(String[] args) {
    ...
    PopulateDemoData.resetData("Chapter08-TransactionSamples-JTA", System.out);
  }
  ...
  private PopulateDemoData(String persistenceUnit) {
    /**
     * En lugar de inyectar un ejb facade usando la anotacion @EJB, instanciamos el java facade (JavaServiceFacade) a traves
     * del constructor y le pasamos el nombre de la unidad de persistencia de un RESOURCE_LOCAL
     */
